...
class BruteForceProtection:
    def __init__(
        ...
        use_redis=None,
        progressive=PROGRESSIVE_LOCKOUT,
    ):
    ...
    def _record_attempt_memory(self, identifier):
        ...
        with _store_lock:
            _attempt_store[identifier] = [
                ts for ts in _attempt_store[identifier] if ts > window_start
            ]
    ...
    def decorator(view_func):
        ...
        def decorated_function(*args, **kwargs):
            ...
            if is_locked:
                ...
                log_security_event(
                    AuditEvents.SECURITY_BRUTE_FORCE,
                    {"identifier_type": identifier_type, "remaining_lockout": remaining},
                )
